...
export const user = pgTable("user", {
  ...
  updatedAt: timestamp("updated_at")
    ...
    .notNull(),
  // Added by better-auth's `admin` plugin (packages/db is hand-maintained,
  // not generated by better-auth's CLI, so these are added manually to
  // match what the plugin's Drizzle adapter expects).
...
export const session = pgTable(
  "session",
  {
    ...
    // Added by better-auth's `admin` plugin (see `user` table comment above).
